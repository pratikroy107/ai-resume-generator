  ...
  const handleDownloadPdf = () => {
    toPng(resumeRef.current, { quality: 1.0 })
      .then((dataUrl) => {
        ...
        const imgHeight = (resumeRef.current.offsetHeight * imgWidth) / resumeRef.current.offsetWidth; // Calculate the height of the image
        ...
        while (remainingImgHeight > 0) {
          pdf.addImage(dataUrl, "PNG", 10, position, imgWidth, 0);
          remainingImgHeight -= pageHeight - 20; // Subtract the height of the page (minus margins)
          position -= pageHeight - 20; // Move the position up for the next page
